...
while (width == "") {
  ...
  counter++;
  if (counter > 50) width = 195;
}
var lollipopRadius;
if (width > 1200) lollipopRadius = 10;
else if (width > 700) lollipopRadius = 8;
else lollipopRadius = 5;
...
var xUrgency = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xCoverage = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xInclusiveness = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xFinancing = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xQuality = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xAlignment = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);

var xFlexiguidance = d3.scaleLinear().range([0, widthDash - 2 * marginDash]);
...
var yBar = d3.scaleLinear().range([heightBar - marginBar, marginBar]);
...
var dimGuides = [
  {
    dimGuide: "urgencyData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "participationData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "inclusivenessData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "financingData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "alignmentData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "qualityData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
  {
    dimGuide: "flexiguidanceData",
    guides: ["← no discrimination", "very high discrimination →"],
  },
];
...
function render(
  ...
  alignment
    ...
    .forEach(function (k) {
      if (k.value != "NA") alignmentRank.push(k.value);
    });
  ...
  financing
    ...
    .forEach(function (k) {
      if (k.value != "NA") financingRank.push(k.value);
    });
  ...
  flexiguidance
    ...
    .forEach(function (k) {
      if (k.value != "NA") flexiguidanceRank.push(k.value);
    });
  ...
  inclusiveness
    ...
    .forEach(function (k) {
      if (k.value != "NA") inclusivenessRank.push(k.value);
    });
  ...
  participation
    ...
    .forEach(function (k) {
      if (k.value != "NA") participationRank.push(k.value);
    });
  ...
  quality
    ...
    .forEach(function (k) {
      if (k.value != "NA") qualityRank.push(k.value);
    });
  ...
  urgency
    ...
    .forEach(function (k) {
      if (k.value != "NA") urgencyRank.push(k.value);
    });

  d3.map(alignment, function (d) {
    return d.Country;
  })
    .keys()
    .forEach(function (d) {
      dimension.push({ Country: d });
    });
    ...
    if (d.variable == "Total") {
      dimension.forEach(function (k) {
        if (k.Country == d.Country) {
          k.alignment = d.value;
          k.alignmentRanking =
            alignmentRank.sort().reverse().indexOf(d.value) + 1;
        }
      });
    }
  });
    ...
    if (d.variable == "Total") {
      dimension.forEach(function (k) {
        if (k.Country == d.Country) {
          k.financing = d.value;
          k.financingRanking =
            financingRank.sort().reverse().indexOf(d.value) + 1;
        }
      });
    }
  });
    ...
    if (d.variable == "Total") {
      dimension.forEach(function (k) {
        if (k.Country == d.Country) {
          ...
          k.flexiguidanceRanking =
            flexiguidanceRank.sort().reverse().indexOf(d.value) + 1;
        }
      });
    }
  });
    ...
    if (d.variable == "Total") {
      dimension.forEach(function (k) {
        if (k.Country == d.Country) {
          ...
          k.inclusivenessRanking =
            inclusivenessRank.sort().reverse().indexOf(d.value) + 1;
        }
      });
    }
  });
    ...
    if (d.variable == "Total") {
      dimension.forEach(function (k) {
        if (k.Country == d.Country) {
          ...
          k.participationRanking =
            participationRank.sort().reverse().indexOf(d.value) + 1;
        }
      });
    }
  });
  ...
  createDashboard(
    urgency.filter(function (d) {
      return d.variable == "Total";
    }),
    participation.filter(function (d) {
      return d.variable == "Total";
    }),
    inclusiveness.filter(function (d) {
      return d.variable == "Total";
    }),
    financing.filter(function (d) {
      return d.variable == "Total";
    }),
    quality.filter(function (d) {
      return d.variable == "Total";
    }),
    alignment.filter(function (d) {
      return d.variable == "Total";
    }),
    flexiguidance.filter(function (d) {
      return d.variable == "Total";
    })
  );
